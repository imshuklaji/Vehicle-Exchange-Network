...
echo "Updating chaincode on peer0.carcompany.vehicle-exchange-network.com ..."
installChaincode 0 'carcompany' $VERSION
echo "Updating chaincode on peer1.ind1.vehicle-exchange-network.com ..."
installChaincode 0 'ind1' $VERSION
echo "Updating chaincode on peer0.ind2.vehicle-exchange-network.com ..."
installChaincode 0 'ind2' $VERSION
echo "Updating chaincode on peer0.ind3.vehicle-exchange-network.com ..."
installChaincode 0 'ind3' $VERSION

# Upgrade chaincode on the channel using peer0.carcompany
echo "Upgrading chaincode on channel using peer0.carcompany.vehicle-exchange-network.com ..."
upgradeChaincode 0 'carcompany' $VERSION
